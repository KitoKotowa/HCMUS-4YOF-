...
begin
	using  Distributions, Plots, Images, LinearAlgebra, Statistics , Random
end
...
begin
	...
	num_epochs=2000
	learning_rate=0.01
	W, losses, W_list = train(W, add_one_train_x, train_y_new, learning_rate, num_epochs)
end
...
- The runs are to seperate one value label and no value label datas
- The accurracy score is pretty high (consistently at nearly 90%)
