...
public class RemoveLowFreq {

  public static class RemoveLowFreqMapper extends Mapper<LongWritable, Text, Text, IntWritable>{
  ...
  public static class RemoveLowFreqReducer  extends Reducer<Text,IntWritable,Text,IntWritable> {
